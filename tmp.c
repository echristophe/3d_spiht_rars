...
#endif
outputsize[thres_ind]=(*(datablock[blockind].streamlast))*8 + (*(datablock[blockind].count)); //add a +1 ???
...
//do not forget to free each block separatly first... TODO
for (i=0;i<nblock;i++){
