...
#test 
# C_OPT = -O3 -DEZW -DDEBUG
# C_OPT = -O3 -DEZW -DDEBUG -DEZW_ARITH
# C_OPT = -O3 -DEZW -DDEBUG  -DNEWTREE2
# C_OPT = -O3 -DEZW -DDEBUG -DNEWTREE -DEZWUSEZ -DEZWREFAFTER -DEZW_ARITH -DEZW_ARITH_RESET_MODEL
...
# C_OPT = -O3 -DEZW -DDEBUG -DNEWTREE -DSIGNED -DEZWUSEZ -DEZW_ARITH -DEZW_ARITH_CONTEXT
