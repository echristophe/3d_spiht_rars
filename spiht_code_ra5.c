...
int spiht_code_ra5(long int *image, unsigned char *stream, long int *outputsize, struct coder_param_struct coder_param)
{
...
int spiht_decode_ra5(long int *image, unsigned char *stream, long int *outputsize, struct coder_param_struct coder_param)
{
