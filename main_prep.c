...
# 1 "/usr/lib/gcc/i486-linux-gnu/4.0.4/include/stddef.h" 1 3 4
# 214 "/usr/lib/gcc/i486-linux-gnu/4.0.4/include/stddef.h" 3 4
typedef unsigned int size_t;
# 326 "/usr/lib/gcc/i486-linux-gnu/4.0.4/include/stddef.h" 3 4
typedef int wchar_t;
...
# 1 "/usr/lib/gcc/i486-linux-gnu/4.0.4/include/stddef.h" 1 3 4
# 355 "/usr/lib/gcc/i486-linux-gnu/4.0.4/include/stddef.h" 3 4
...
# 1 "/usr/lib/gcc/i486-linux-gnu/4.0.4/include/stdarg.h" 1 3 4
# 43 "/usr/lib/gcc/i486-linux-gnu/4.0.4/include/stdarg.h" 3 4
...
char * output_filename = (char *) calloc(256,sizeof(char));
 ...
 if ((selected == 0) && (!size_supplied)){
  imageprop.nsmax = 256;
  imageprop.nlmax = 256;
  imageprop.nbmax = 224;
 }
 if ((selected == 0) && (!ndecomp_supplied)){
...
long int *imageori=((void *)0);


long int * mean=((void *)0);
long int *image=((void *)0);
unsigned char * stream=((void *)0);
...
for (i_l=0;i_l<imageprop.nresspat-1;i_l++){
 imageprop.nsmin = ceil(imageprop.nsmin / 2.0);
 imageprop.nlmin = ceil(imageprop.nlmin / 2.0);
}
...
stream = (unsigned char *) calloc(type*npix,sizeof(unsigned char));
...
if (output_file == ((void *)0)) fprintf(stderr, "Error opening file...\n");
...
long int * imageidwt=((void *)0);
short * imageitmp=((void *)0);
unsigned char * imageitmpbyte=((void *)0);
long int * imageoritmp=((void *)0);
long int *imagedwtori=((void *)0);

long int * image=((void *)0);
long int * imagepart=((void *)0);
long int * imagesav=((void *)0);
long int * imagepartori1=((void *)0);
short int * imagepartori=((void *)0);
long int * imageidwtori=((void *)0);
unsigned char * stream=((void *)0);
long int * streamlast=(long int *) calloc(1,sizeof(long int));
unsigned char * count=(unsigned char *) calloc(1,sizeof(unsigned char *));
struct stream_struct streamstruct;
...
if (stream_file == ((void *)0)) fprintf(stderr, "Error opening file...\n");
stream_size = file_size(stream_file);

printf("Reading %ld bytes\n",stream_size);
stream = (unsigned char *) malloc(stream_size*sizeof(unsigned char));
status = fread(stream, 1, stream_size, stream_file);
...
image=imagepart;
imagepart=imagesav;
free(imagepart);imagepart=((void *)0);
...
free(imageidwt);imageidwt=((void *)0);
# 962 "main.c"
free(maxquantvalue);
free(outputsize);
